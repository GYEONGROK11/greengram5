...
public class ApartmentTransactionDetailVo {
    ...
    private String areaForExclisiveUse;
    ...
    public void setDealAmount(String dealAmount){
        ...
        // ","(콤마)를 ""(빈칸)으로 바꿔줌  .trim은 앞뒤 공백 날려줌  ex) " 82,500" 문자열을 -> 82500 정수로
    }
    @JsonSetter("건축년도")
    ...
    @JsonSetter("전용면적")
    public void setAreaForExclisiveUse(String areaForExclisiveUse) {this.areaForExclisiveUse = areaForExclisiveUse;}
    @JsonSetter("지번")
    ...
    @JsonGetter("areaForExclisiveUse")
    public String getAreaForExclisiveUse() {return areaForExclisiveUse;}
    @JsonGetter("jibun")
